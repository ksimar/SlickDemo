...
object Hello extends App {
  ...
  val combined = Await.result(ProjectComponent.combinedActions(Project(6,"Akka"), Project(7,"Kafka")), 10000 second)
  //val res1 = combined.map(res => s"$res inserted")
  println()
  val selectAllEmployees2 = Await.result(EmployeeComponent.getAll(), 10000 second)
  println("All employees: "+selectAllEmployees2 )
  println("Result: "+combined+ " rows inserted")
  println("All employees after combined action: "+selectAllProjects )
  Thread.sleep(20000)
